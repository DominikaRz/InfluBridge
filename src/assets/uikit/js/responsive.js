...
jQuery(document).ready(function($) {
    var alterClass = function() {
        ...
        if (ww > 944) {     //bigger
            $('.hidden-small').removeClass('uk-hidden');               //show element
            $('#inf-side-card').removeClass('uk-hidden');               //show element
            $('#brd-side-card').removeClass('uk-hidden');               //show element
        ...
        else if (ww < 945) { //smaller
            $('.hidden-small').addClass('uk-hidden');                  //hide element
            $('#inf-side-card').addClass('uk-hidden');                  //hide element
            $('#brd-side-card').addClass('uk-hidden');                  //hide element
